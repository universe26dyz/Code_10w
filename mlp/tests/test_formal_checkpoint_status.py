...
def test_unvalidated_formal_candidate_is_rejected_by_online_loader(tmp_path):
    ...
    data.update({"functional_fixture": False, "scientific_checkpoint": True, "formal_candidate": True, "validation_status": "unvalidated", "dataset_schema": "mlp_rr_synthetic/v1", "dataset_split_mode": "rhythm"})
